...
val Typography = Typography(
    ...
    h1 = TextStyle(
        fontFamily = Gotham, fontWeight = FontWeight.Bold, fontSize = 24.sp
    ),

    body1 = TextStyle(
        fontFamily = Gotham, fontWeight = FontWeight.Normal, fontSize = 16.sp
    ), body2 = TextStyle(
        fontFamily = Gotham,
        ...
        fontFamily = Gotham, fontWeight = FontWeight.Normal, fontSize = 48.sp, letterSpacing = 0.sp
    ), h4 = TextStyle(
        fontFamily = Gotham,
        fontWeight = FontWeight.Normal,
        fontSize = 34.sp,
        ...
        fontFamily = Gotham, fontWeight = FontWeight.Normal, fontSize = 24.sp, letterSpacing = 0.sp
    ), h6 = TextStyle(
        fontFamily = Gotham,
